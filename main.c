...
#define Ready_PF3								(*((volatile unsigned long *)0x40025020))
#define VT_PF1									(*((volatile unsigned long *)0x40025008))
...
void SetVT(void){
// write this function
	VT_PF1 |= 0x02;														// Set PF1 turn on red led
}
...
void ClearVT(void){
// write this function
	VT_PF1 = VT_PF1&~0x02;										// Clear PF1 turn off red led
}
...
void SetReady(void){
// write this function
	Ready_PF3 |= 0x08;												// Set PF3 turn on green led
}
...
void ClearReady(void){
// write this function
	Ready_PF3 = Ready_PF3&~0x08;						 	// Clear PF3 turn off green led
}
